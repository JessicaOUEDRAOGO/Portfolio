...
const SITE = {
  identity: {
    ...
    motivation: "Ce qui me motive : donner à un système physique la capacité de percevoir ce qui l'entoure et de commander ses actions en fonction de ce qu'il observe. C'est ce qui m'a amenée à combiner l'automatisation, la vision par ordinateur et la XR : exploiter les données issues du système et de son environnement pour mieux agir sur lui ou interagir avec lui. C'est cette volonté de rapprocher le monde physique et le numérique qui guide mes projets."
  },
    ...
    xr: {
      ...
      projects: [
        ...
        },
        {
          ...
          meta: "Hackathon",
          problem: "Sans le vivre soi-même, il est difficile d'imaginer à quel point un geste simple devient difficile avec la maladie de Parkinson.",
          solution: "Une simulation VR développée en 48h (hackathon), qui reproduit en temps réel les tremblements de la main liés à la maladie, avec une intensité réglable, pour faire vivre un geste simple comme un patient le ressent.",
          result: "Un prototype qui rend un handicap invisible immédiatement perceptible. Le même principe — simuler une déficience pour sensibiliser — s'applique à la formation de tout aidant, professionnel de santé ou concepteur de produit accessible.",
        ...
        },
        {
          ...
          problem: "La formation à distance manque souvent d'interaction réelle entre apprenants et formateur — impossible de manipuler un objet ensemble ou de garder une vraie dynamique de classe.",
          solution: "Un environnement multi-utilisateurs avec manipulation d'objets partagée, tableau blanc collaboratif, gestion des rôles formateur/apprenant, et communication vocale intégrée.",
          result: "Un environnement qui reproduit la dynamique d'une salle de classe réelle à distance. Applicable à toute formation nécessitant de la pratique collective : gestes techniques, procédures de sécurité, travail d'équipe.",
